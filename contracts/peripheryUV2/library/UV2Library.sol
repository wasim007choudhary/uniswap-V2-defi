...
library UV2Library {
    ...
    /**
     * @notice Multi-Hop Swap Output Calculator
     *
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        ///notice In 0.5.0: as Uniswapv2 uses - address(uint(keccak256...)) worked, but 0.8.0+ requires uint160(uint256(keccak...)) which I am usinf
        pair = address(
            uint160(
                uint256(
                    keccak256(
